...
const MODES: Mode[] = [
  {
    ...
    label: "Deep Work",
    description:
      "Notifications held. Calendar paused. Anything that costs more than three seconds to recover from is dimmed.",
  ...
  },
  {
    ...
    description:
      "Lateral connections rewarded. Search history surfaced. New tabs allowed to wander.",
  ...
  },
  {
    ...
    label: "Meeting Ready",
    description:
      "Camera-aware focus. Notes surface 2 minutes before each call. Mic and lighting checked silently.",
  ...
  },
  {
    ...
    label: "Recover",
    description:
      "Post-meeting decompression. Slack delayed. Email muted. Breath cadence visible.",
    ...
    <div>
      ...
      <div className="mt-16 grid lg:grid-cols-12 gap-10">
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow: isActive
                    ? "0 20px 60px -30px rgba(124,195,255,0.35)"
                    : undefined,
                }}
              >
                <span className={`mode-dot ${isActive ? "active" : ""}`} />
                <div className="flex-1">
                  <div className={`text-[16px] ${isActive ? "text-bone" : "text-silver-300"}`}>
                    {m.label}
                  </div>
                  <div className="text-[12px] font-mono text-silver-500">{m.meta}</div>
                </div>
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                  fill="none"
                  className={isActive ? "text-signal" : "text-silver-500"}
                  aria-hidden
                >
                  <path
                    d="M3 10.5L10.5 3M10.5 3H5M10.5 3V8.5"
                    stroke="currentColor"
                    strokeWidth="1.4"
                    strokeLinecap="round"
                  />
        ...
        <div className="lg:col-span-7">
          <div
            className="rounded-3xl p-10 min-h-[480px] flex flex-col justify-between relative overflow-hidden"
            style={{
              background:
                "linear-gradient(180deg,rgba(24,24,27,0.85),rgba(14,14,16,0.85))",
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-signal">
                  {current.label}
                </span>
              </div>
              <p className="display text-[32px] sm:text-[44px] mt-8 leading-[1.05] text-balance">
                {current.description}
              </p>
            </div>
            <div className="relative mt-12 pt-8 border-t border-white/5 flex flex-wrap justify-between gap-4">
              <div>
                <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-silver-500">
                  System status
                </div>
              ...
              <div className="text-right">
                ...
                <div className="mt-2 text-[14px] text-silver-300">{current.meta}</div>
              </div>
            </div>
          </div>
        </div>
